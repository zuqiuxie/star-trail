  ...
  <main bg-transparent absolute w-full top-75vh z-10>
    ...
    <section mx-9vw mt-90>
      ...
      <div mb-10 flex flex-wrap justify-between>
        <div v-for="(item, index) in data.myProjects" :key="index" mx-10 my-4 class="basis-3/4 md:basis-1/6">
          <a :href="item.link">
            <div class="bg-white/5 hover:bg-white/10" p-2 rounded-lg shadow-md flex-col transition backdrop-blur-3xl backdrop-opacity-160 hover:backdrop-opacity-100 hover:-translate-y-12>
    ...
    <footer mb-5>
      ...
      <div class="text-white/60" mt-2 f-c-c gap-4>
         <footer>
         <p>© 2025 小王同学 | <a href="https://beian.miit.gov.cn" target="_blank" style="color: white; text-decoration: none;">陕ICP备2023010978号-1</a></p>
         </footer>
      </div>
    </footer>
  </main>
